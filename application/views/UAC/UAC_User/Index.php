    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        <a class="btn btn-primary" href="<?= site_url('UAC_User/Create') ?>">Add User</a>
                    </div>
                    <div class="col-md-8">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $('#table').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= site_url('UAC/Ajax_Datatables/get_data_user_admin') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0],
...
<script>
    function hapus(uid) {
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location.href = "<?= site_url('UAC_User/Delete?id='); ?>" + uid;
                } else {
                    swal("User is safe!");
                }
            });
